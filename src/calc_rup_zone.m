function [rup_zone,rup_pt,rup_ax] = calc_rup_zone(s_param,s_c,s_v,thres)
...
rz_ll(:,2) = slip_profile_fun(rz_ll,s_param(1),0,s_param(3),s_param(4),           s_param(5),s_param(6));
rz_ul(:,2) = slip_profile_fun(rz_ul,s_param(1),0,s_param(3),s_param(4)+s_param(2),s_param(5),s_param(6));
